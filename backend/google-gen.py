...
# ✅ Correct Google Gemini import and setup
...
def analyze_frame_with_gemini(frame: Image):
    try:
        response = genai.generate_content(
            ...
            contents=[{"mime_type": "image/jpeg", "data": frame.tobytes()},
                      {"text": "Is there an accident? Reply True or False."}]
        )
...
def detect_vehicle_type(frame: Image):
    try:
        response = genai.generate_content(
            ...
            contents=[{"mime_type": "image/jpeg", "data": frame.tobytes()},
                      {"text": "What type of vehicle is in this accident? Choose one: car, truck, bus, bike, auto, or other."}]
        )
